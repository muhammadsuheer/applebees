...
const faqData = [
  {
    ...
    answer: "Most standalone locations open at 11:00 AM, seven days a week. Applebee's doesn't serve breakfast, so there's no earlier opening. Dual-branded Applebee's and IHOP locations open earlier to serve breakfast."
  },
  {
  ...
  },
  {
    ...
    answer: "No. There's no breakfast menu at standalone locations, which is why they open at 11:00 AM. Dual-branded locations shared with IHOP serve breakfast from the IHOP side of the menu."
  },
  {
    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.clusterSection} id="standard-hours">
          ...
          <p>
            The reason is that Applebee's doesn&apos;t serve breakfast. There&apos;s no breakfast menu, no breakfast prep, and no reason to staff a morning shift. Opening at 11:00 lands just ahead of the lunch rush without paying for the hours before it.
          </p>
          <p>
            This is why searches for Applebee's breakfast hours come up empty. The meal doesn&apos;t exist on the menu. See the <Link href="/menu">full menu</Link> for what is served.
          </p>
        ...
        <section className={styles.clusterSection} id="kitchen-close">
          ...
          <p>
            This is the detail that catches people out, and it&apos;s the most useful thing on this page.
          </p>
          <p>
        ...
        <section className={styles.clusterSection} id="holiday-hours">
          ...
          <p>
            Many locations open on Thanksgiving, though usually on a shortened schedule, opening later in the afternoon and closing earlier than normal. Applebee's doesn&apos;t typically serve a traditional holiday menu; the regular menu runs.
          </p>
          <p>
            The demand is real but specific: travelers, people who aren&apos;t cooking, and the evening crowd. Whether your restaurant opens is a local call, so check before assuming either way.
          </p>
          ...
          <p>
            If you&apos;re planning a Christmas Eve meal, plan it early and confirm the closing time first.
          </p>
          ...
          <p>
            New Year's Eve commonly runs later than a normal Friday or Saturday, since it&apos;s one of the busiest bar nights of the year. New Year's Day usually returns to standard hours.
          </p>

          <h3>Summer holidays</h3>
          <p>
            Memorial Day, Independence Day and Labor Day usually run standard hours. Lunch trade tends to be quieter and evening trade busier, but the schedule generally doesn&apos;t change.
          </p>
        </section>
        ...
        <section className={styles.clusterSection} id="check-hours">
          ...
          <p>
            Search engine listings are the least reliable source on holidays. Map listings pull from a mix of scraped data and user submissions. If a manager decides on the day to close early, the listing usually doesn&apos;t reflect it.
          </p>
          <p>
