    ...
    <main className={styles.main}>
      ...
      <div className={styles.pageContainer}>
        ...
        <header className={styles.heroSection} role="banner">
          ...
          <p>
            This page lays out calories, fat, saturated fat, cholesterol, sodium, carbohydrates, fiber, sugar and protein for the most-ordered items across six categories, plus allergen flags for each one. There is also a calculator for building a meal and seeing the totals before ordering.
          </p>
          <div className={styles.highlightBadge}>
            <strong>The short version:</strong> Applebee's is very workable if the target is protein, and harder work if the target is sodium.
          </div>
        </header>

        {/* Section 2 — The Thing Most People Miss */}
        <section className={styles.contentCard} id="sodium-vs-calories">
          ...
          <p>
            The Boneless Wings in Classic Hot Buffalo from the <Link href="/menu/appetizers">appetizer menu</Link> come in at 1,080 calories — high, but not shocking for a shared appetizer. The sodium figure is 4,720 mg. The FDA's recommended daily limit is 2,300 mg. One appetizer is roughly two days' worth of sodium.
          </p>
          <p>
        ...
        <section className={styles.contentCard} id="nutrition-calculator">
        ...
        <section className={styles.contentCard} id="nutrition-tables">
          ...
          {/* Appetizers */}
          <div className={styles.tableCategoryBlock} id="appetizers-nutrition">
            <h3>Appetizers Nutrition</h3>
            <p className={styles.categorySubtext}>
              Appetizers are the highest-sodium category on the <Link href="/menu/appetizers">appetizer menu</Link>, and most are designed to be shared rather than eaten alone. Also check <Link href="/happy-hour">happy hour</Link> or <Link href="/specials-and-deals">current specials</Link> for half-price app deals.
            </p>
            ...
            <div className={styles.tableInsight}>
          ...
          {/* Salads & Soups */}
          <div className={styles.tableCategoryBlock} id="salads-soups-nutrition">
          ...
          {/* Steaks, Ribs & Chicken */}
          <div className={styles.tableCategoryBlock} id="steaks-ribs-chicken-nutrition">
          ...
          {/* Seafood & Pasta */}
          <div className={styles.tableCategoryBlock} id="seafood-pasta-nutrition">
            <h3>Seafood & Pasta Nutrition</h3>
            <p className={styles.categorySubtext}>
              Check our <Link href="/menu/seafood">seafood menu</Link> and <Link href="/menu/pasta">pasta dishes</Link> for detailed recipe variations and portion breakdowns.
            </p>
            <div className={styles.tableCard}>
              <div className={styles.tableResponsive}>
                <table className={styles.nutritionTable}>
          ...
          {/* Burgers & Sandwiches */}
          <div className={styles.tableCategoryBlock} id="burgers-sandwiches-nutrition">
          ...
          {/* Sides & Desserts */}
          <div className={styles.tableCategoryBlock} id="sides-desserts-nutrition">
            ...
            <div className={styles.tableInsight} style={{ marginTop: '10px' }}>
        ...
        <section className={styles.contentCard} id="allergen-guide">
        ...
        <section className={styles.contentCard} id="gluten-free-options">
        ...
        <section className={styles.contentCard} id="dairy-free-options">
        ...
        <section className={styles.contentCard} id="vegetarian-vegan-options">
        ...
        <section className={styles.contentCard} id="highest-lowest-calories">
          <h2>Highest and Lowest Calorie Items at Applebee's</h2>
          <div className={styles.snippetGrid}>
            <div className={styles.snippetItem}>
              <span className={styles.snippetLabel}>Highest Calorie</span>
              <p>Hand-Battered Fish & Chips (1,680 cal), Whisky Bacon Burger (1,590 cal), Oriental Chicken Salad (1,560 cal).</p>
            </div>
            <div className={styles.snippetItem}>
              <span className={styles.snippetLabel}>Lowest Calorie</span>
              <p>Steamed Broccoli (100 cal), Garlicky Green Beans (150 cal), House Salad with Fat Free Italian (160 cal).</p>
            </div>
            <div className={styles.snippetItem}>
              <span className={styles.snippetLabel}>Highest Protein</span>
              <p>Three-Cheese Chicken Penne (77g), Bourbon Street Steak (71g), Bacon Ranch Chicken Sandwich (64g).</p>
            </div>
            <div className={styles.snippetItem}>
              <span className={styles.snippetLabel}>Highest Sodium</span>
              <p>Boneless Wings in Classic Hot Buffalo (4,720 mg) — more than double the recommended daily limit.</p>
            </div>
            <div className={styles.snippetItem}>
              <span className={styles.snippetLabel}>Highest Sugar</span>
              <p>Triple Chocolate Meltdown (87g), Oriental Chicken Salad (45g), Four-Cheese Mac & Cheese (44g).</p>
            </div>
            <div className={styles.snippetItem}>
              <span className={styles.snippetLabel}>Highest Sat. Fat</span>
              <p>Three-Cheese Chicken Penne (40g saturated fat).</p>
            </div>
            <div className={styles.snippetItem} style={{ gridColumn: '1 / -1' }}>
              <span className={styles.snippetLabel}>Best Protein-to-Calorie Ratio</span>
              <p>8 oz. Top Sirloin — 55g protein for 830 calories (about 15 calories per gram of protein).</p>
            </div>
          </div>
        </section>

        {/* Section 10 — Eating by Goal */}
        <section className={styles.contentCard} id="ordering-by-goal">
        ...
        <section className={styles.contentCard} id="kids-menu-nutrition">
          ...
          <div className={styles.tableCard} style={{ maxWidth: '650px', margin: '20px 0' }}>
            <div className={styles.tableResponsive}>
              <table className={styles.nutritionTable}>
                <thead>
                  <tr>
                ...
                <tbody>
                  {kidsMenuData.map((k, idx) => (
                    <tr key={idx}>
                      ...
                      <td className={styles.sodiumCell} style={{ textAlign: 'right' }}>{k.sodium}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <section className={styles.contentCard} id="drink-calories">
        ...
        {/* Section 13 — FAQ */}
        <section className={styles.contentCard} id="faqs">
