...
const faqData = [
  ...
  },
  {
    ...
    answer: "No. They never expire and don't decrease in value, with no dormancy or maintenance fees. Promotional bonus cards received during holiday offers are separate and do carry expiry dates."
  },
  {
    question: "Can I use an Applebee's gift card on DoorDash or Uber Eats?",
    answer: "No. Applebee's states that delivery service providers don't accept its gift cards. To pay by gift card for food at home, order through applebees.com or the Applebee's app."
  },
  {
    question: "Can I reload an Applebee's gift card?",
    answer: "No. Applebee's gift cards aren't reloadable. Once the balance is spent, you'd need a new card."
  },
  {
    question: "Can I buy a gift card using a gift card?",
    answer: "No. Applebee's gift cards aren't redeemable for other gift cards."
  },
  {
  ...
  },
  {
    ...
    answer: "No. Applebee's doesn't have a Meal Pass program. Any card sold as an \"Applebee's Meal Pass Card\" isn't issued by Applebee's and can't be redeemed at any location."
  },
  {
    question: "Can I buy an Applebee's gift card over the phone?",
    answer: "No. Applebee's doesn't accept gift card orders by phone for security reasons. Cards can be bought in-restaurant or through the official website."
  },
  {
    question: "How long does a physical gift card take to arrive?",
    answer: "Orders process and ship within two days, with delivery speeds from standard mail to overnight. Cards sent by UPS can't be delivered to a PO Box."
  },
  {
    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.clusterSection} id="check-balance">
          ...
          <p>
            <strong>Important, and this catches people out:</strong> The balance checker doesn&apos;t run on applebees.com. It opens on a third-party payments domain, because Applebee's gift cards are powered by CashStar and the balance system sits with its stored-value provider.
          </p>
          <p>
            That&apos;s expected and legitimate, but it means "only trust applebees.com URLs" is advice that will make you distrust the real tool. The safe rule isn&apos;t the domain, it&apos;s the path: always start at applebees.com and follow the link from there. Never arrive at a balance checker from a search ad or an emailed link.
          </p>

          <h3>By phone</h3>
          <p>
            Call <strong>1-800-252-6722</strong>. This is the number Applebee's publishes for gift card inquiries, including lost cards. Have the card number, or the purchase receipt, ready before calling.
          </p>
          <p>
            Phone is the most reliable route if you&apos;re unsure about a website, because there&apos;s no URL to get wrong.
          </p>

          <h3>In a restaurant</h3>
          <p>
            Any Applebee's can run the card at the till and tell you the balance. No account, no website, no typing a number into anything. If you&apos;re near a location, this is the simplest option, and the only one where you never enter your card details online at all.
          </p>
            ...
            <div className={styles.tableResponsive}>
              <table className={styles.customTable}>
                ...
                <tbody>
                  ...
                  <tr>
                    <td data-label="Situation">You&apos;re unsure whether a site is genuine</td>
        ...
        <section className={styles.clusterSection} id="gift-card-scams">
          ...
          <ul className={styles.textList}>
            ...
            <li>
              <strong>The mystery shopper scheme:</strong> A check arrives with instructions to deposit it, buy gift cards, and send the numbers back. The check bounces after the cards are gone.
            </li>
          </ul>
          ...
          <p>
            Searching for a balance check surfaces paid ads and lookalike sites. Entering a card number and PIN on one of them empties the card within seconds, and a drained card isn&apos;t usually refunded. Go through applebees.com every time rather than through a search result.
          </p>

          <h3>Tampered cards on the rack</h3>
          <p>
            Applebee's advises checking the packaging before buying. If it looks opened, resealed, torn, or the PIN panel has been scratched, don&apos;t buy it. Take it to store management. Cards are sometimes recorded in-store and then drained the moment they&apos;re activated.
          </p>

          <h3>"Free" or discounted gift card offers</h3>
          <p>
            Applebee's states plainly that its gift cards aren&apos;t free, and that ads or sites offering free or heavily discounted cards are scams.
          </p>
        ...
        <section className={styles.clusterSection} id="expiry-and-value">
          ...
          <div className={styles.answerBlock}>
            <p>
              No. Applebee's gift cards never expire and don&apos;t decrease in value. There are no dormancy fees, maintenance fees, or deductions for non-use.
            </p>
          </div>

          <p>
            Federal law backs this up: under the Credit CARD Act of 2009, funds on a purchased gift card can&apos;t expire for at least five years from the date of issue, and inactivity fees are tightly restricted. Applebee's goes further than the legal minimum by not applying an expiry at all.
          </p>
          <p>
          ...
          <p>
            During holiday promotions, buying a gift card sometimes comes with an additional bonus card. That bonus card isn&apos;t the same thing.
          </p>
          <p>
          ...
          <p>
            <strong>Practical rule:</strong> Spend the bonus card first, keep the purchased card as long as you like. The bonus card is the one with a deadline, and the deadline is printed on it or in the promotion terms. Once it passes, it can&apos;t be reinstated at the till.
          </p>
        </section>
        ...
        <section className={styles.clusterSection} id="where-cards-work">
          ...
          <ul className={styles.textList}>
            <li>
              <strong>Third-party delivery platforms:</strong> Applebee's states directly that delivery service providers don&apos;t accept its gift cards. If you want to pay with a gift card for food at home, order through Applebee's own site or app. See <Link href="/delivery">delivery</Link> and <Link href="/takeout">takeout</Link>.
            </li>
            <li>
              <strong>Any other business:</strong> Applebee's cards are only redeemable at Applebee's.
            </li>
            <li>
              <strong>Buying another gift card:</strong> Applebee's gift cards aren&apos;t redeemable for gift cards.
            </li>
          </ul>
          ...
          <h3>US and Canada</h3>
          <p>
            Gift cards bought in either the US or Canada are accepted in both countries, and cross-currency redemption works between the two. That doesn&apos;t extend beyond those two markets.
          </p>

          <h3>Not reloadable</h3>
          <p>
            Once a card's balance is spent, it can&apos;t be topped up. Applebee's doesn&apos;t offer reloading. A new card is the only route. Worth knowing before you plan to keep one card as a running balance.
          </p>
        </section>
        ...
        <section className={styles.clusterSection} id="how-to-buy">
          ...
          <ul className={styles.textList}>
            ...
            <li><strong>Online, physical:</strong> Orders process and ship within two days, with delivery options from standard mail to overnight. Cards shipped by UPS can&apos;t be delivered to a PO Box. Use a street address.</li>
            ...
            <li><strong>Not by phone:</strong> Applebee's doesn&apos;t take gift card orders over the phone, for security reasons. Anyone calling to sell you one isn&apos;t Applebee's.</li>
          </ul>
        ...
        <section className={styles.clusterSection} id="lost-or-stolen">
          ...
          <p>
            A gift card is a bearer instrument. Whoever holds it can use it, and there&apos;s no name attached to it. That&apos;s why Applebee's asks for the card number or the receipt. Without one of them there&apos;s no way to identify which card is yours among millions in circulation.
          </p>
          <p>
