...
export function HappyHourWindows() {
  return (
    <section className={styles.section} id="two-windows-explained">
      ...
      <p>The most defining characteristic of the Applebee's Happy Hour is that it doesn&apos;t run continuously. To protect peak dining hours (lunch and dinner service), the promotion is strictly segregated into two distinct temporal windows. These windows target entirely different demographics and serve unique operational purposes for the restaurant.</p>
...
export function HalfPriceAppetizers() {
  return (
    <section className={styles.section} id="half-price-apps">
      ...
      <h3>The Universal Exclusions (What You Can&apos;t Get)</h3>
      ...
      <ul>
        ...
        <li><strong>Bone-In Traditional Wings:</strong> The commodity price of bone-in chicken wings fluctuates wildly on the global market. Because they&apos;re significantly more expensive to procure than processed boneless wings (which are essentially chicken breast nuggets), traditional wings are almost always excluded from the 50% discount.</li>
...
export function CompetitorComparison() {
  return (
    <section className={styles.section} id="competitor-comparison">
      ...
      <p>Applebee's doesn&apos;t operate in a vacuum. To objectively evaluate their Happy Hour, we must rigorously compare it against the late-night strategies of their three biggest casual dining competitors in 2026: Chili's Grill & Bar, TGI Fridays, and Buffalo Wild Wings.</p>
